...
class MicropostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create micropost" do
    assert_difference('Micropost.count') do
      post microposts_url, params: { micropost: { animal_id: @micropost.animal_id, content: @micropost.content } }
    end
  ...
  test "should update micropost" do
    patch micropost_url(@micropost), params: { micropost: { animal_id: @micropost.animal_id, content: @micropost.content } }
